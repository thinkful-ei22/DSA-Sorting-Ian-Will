...
function quickSort(array, start=0, end=array.length) {
  ...
  //2nd time through: start becomes middle
  array = quickSort(array, start, middle);
  //// 1st time throught start same, end is middle now
...
const data = [89, 30, 25, 32, 72, 70, 51, 42, 25, 24, 53,55, 78, 50, 13, 
